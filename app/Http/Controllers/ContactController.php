...
class ContactController extends Controller
{
    public function sendContact(Request $req) {
        ...
        //dd($data);
        Mail::to('marketplacebefit@gmail.com')->send(new ContactMail($data));
        return back();
    }
    ...
    public function sendSupport(Request $req) {
        ...
        //dd($data);
        Mail::to('marketplacebefit@gmail.com')->send(new SupportMail($data));
        return back();
    }
    ...
    public function sendCareer(Request $req) {
        ...
        $data['cv'] = $path.'\\'.$name;
        //dd($data);
        Mail::to('marketplacebefit@gmail.com')->send(new CareerMail($data));
        return back();
    }
}
